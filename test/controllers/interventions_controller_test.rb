...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { descripcion: @intervention.descripcion, desde: @intervention.desde, equipo: @intervention.equipo, hasta: @intervention.hasta, mecanico: @intervention.mecanico, repuestos: @intervention.repuestos } }
    end
  ...
  test "should update intervention" do
    patch intervention_url(@intervention), params: { intervention: { descripcion: @intervention.descripcion, desde: @intervention.desde, equipo: @intervention.equipo, hasta: @intervention.hasta, mecanico: @intervention.mecanico, repuestos: @intervention.repuestos } }
