...
class OvertimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create overtime" do
    assert_difference('Overtime.count') do
      post overtimes_url, params: { overtime: { cantidad: @overtime.cantidad, inicio: @overtime.inicio, motivo: @overtime.motivo, personal_id: @overtime.personal_id, termino: @overtime.termino } }
    end
  ...
  test "should update overtime" do
    patch overtime_url(@overtime), params: { overtime: { cantidad: @overtime.cantidad, inicio: @overtime.inicio, motivo: @overtime.motivo, personal_id: @overtime.personal_id, termino: @overtime.termino } }
