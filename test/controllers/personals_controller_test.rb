...
class PersonalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post personals_url, params: { personal: { comentarios: @personal.comentarios, contratado: @personal.contratado, dv: @personal.dv, evaluacion: @personal.evaluacion, nombre: @personal.nombre, rut: @personal.rut } }
    end
  ...
  test "should update personal" do
    patch personal_url(@personal), params: { personal: { comentarios: @personal.comentarios, contratado: @personal.contratado, dv: @personal.dv, evaluacion: @personal.evaluacion, nombre: @personal.nombre, rut: @personal.rut } }
