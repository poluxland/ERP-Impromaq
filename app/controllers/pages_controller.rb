...
scope_tn = Medida.where(turno: "TN").where("EXTRACT(DOW FROM created_at) BETWEEN 1 AND 5")
  ...
  @desp_super_bigbag_month    = {}
  @desp_ultra_bigbag_month    = {}
...
@prod_bb_por_hora_month[month] =
  safe_div(@prodbb_month[month], @horas_bigbag_month[month])
    ...
    @desp_super_bigbag_month[month]    = medidas.sum(&:desp_super_bigbag_ton)
    @desp_ultra_bigbag_month[month]    = medidas.sum(&:desp_ultra_bigbag_ton)
