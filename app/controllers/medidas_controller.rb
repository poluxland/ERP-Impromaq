...
def index
  ...
  private
    ...
    def medida_params
      params.require(:medida).permit(:plastificado_especial, :extra_sacos_soluble, :especial_sacos_soluble, :plastificado_especial_soluble_completo, :plastificado_extra_soluble_completo, :plastificado_especial_zunchos, :plastificado_especial_lados, :plastificado_extra, :plastificado_extra_zunchos, :silo19a, :silo19b, :silo20a, :silo20b, :silo21a, :silo21b, :silo22a, :silo22b, :silo27, :silo28, :especialsacos, :extrsacos, :bigbagextra, :bigbagextra1350, :bigbagextra1, :bigbagespecial, :bigbagsuper, :prodhaver, :prodvento, :tolvacalle5, :silos3000tolva1, :silos3000tolva4, :silos3000tolva5, :silosbigbag1, :silosbigbag2, :silosvento1, :silovento2, :silovento3, :callesilo28, :callesplanta1, :callesilo27, :observaciones, :otros, :ns28, :nbb1, :nbb2, :nvento1, :nvento2, :nvento3, :ns30001, :ns30002, :ns30003, :nivel9, :bigbagplus, :s28c3op, :s28c3cemento, :s28c3nota, :s28c4op, :s28c4cemento, :s28c4nota, :s28c5op, :s28c5cemento, :s28c5nota, :s27c6op, :s27c7cemento, :s27c7nota, :s30c1op, :s30c1cemento, :s30c1nota, :s30c4op, :s30c4cemento, :s30c4nota, :s30c5op, :s30c5cemento, :s30c5nota, :especial_sacos, :especial_bigbag, :especial_granel, :extra_sacos, :extra_bigbag, :extra_granel, :super_3300_granel, :super_4200_granel, :enjuagues_super, :enjuagues_super4, :bigbag_extra_retiro, :prodbb, :horas_bigbag, :horas_vento, :horas_haver, :turno, :comentarios_haver, :comentarios_vento, :comentarios_bigbag, :super_bigbag, :ultra_bigbag)
    end
end
